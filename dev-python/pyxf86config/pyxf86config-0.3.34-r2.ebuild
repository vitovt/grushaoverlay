...
# $Header: /var/cvsroot/gentoo-x86/dev-python/pyxf86config/pyxf86config-0.3.34-r2.ebuild,v 1.9 2009/03/27 22:47:43 jer Exp $
...
SRC_URI="ftp://ftp.isu.edu.tw/pub/Linux/Gentoo/distfiles/${P}-${RPMREV}.fc${FCVER}.src.rpm"
