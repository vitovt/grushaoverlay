...
src_prepare() {
einfo "applying ukrainian translation patches"
cp "${FILESDIR}"/yagf_uk.ts  ${S}/src/
cp "${FILESDIR}"/ts_update.sh  ${S}/src/
cp "${FILESDIR}"/YAGF.desktop  ${S}/
epatch "${FILESDIR}"/CMakeLists.txt_uk.patch
}
