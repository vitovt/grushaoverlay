...
src_unpack() {
	...
	if use natspec; then
#epatch "${FILESDIR}"/deb-unzip-CVE-2008-0888.patch
epatch "${FILESDIR}"/ubuntu-unzip-5.52-security_fix-1.patch
epatch "${FILESDIR}"/unzip-5.50-alt-ddottrav.patch
epatch "${FILESDIR}"/unzip-5.50-alt-makefile.patch
epatch "${FILESDIR}"/unzip-5.52-alt-iconv-v1.1.patch
epatch "${FILESDIR}"/unzip-5.52-alt-natspec.patch
